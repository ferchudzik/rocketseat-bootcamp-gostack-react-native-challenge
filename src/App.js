...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const repositoryIndex = oldRepositories.findIndex(repository => repository.id === newRepository.id);

    oldRepositories[repositoryIndex] = newRepository;
          ...
          renderItem={({ item: repository }) => (
            <>
              ...
              <FlatList
                ...
                keyExtractor={tech => `${repository.id}-${tech}`}
